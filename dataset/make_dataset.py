...
from dataset.preprocess import to_binary_bag_of_words, remove_underrepresented_classes, \
    eliminate_self_loops, binarize_labels
from utils import is_binary_bag_of_words
...
def get_dataset(name, data_path, standardize, train_examples_per_class=None, val_examples_per_class=None):
    ...
    if not is_binary_bag_of_words(node_features):
        print("Converting features of dataset %s to binary bag-of-words representation." %(name, ))
    ...
    assert is_binary_bag_of_words(node_features), "Non-binary node_features entry!"
...
def sample_per_class(random_state, labels, num_examples_per_class, forbidden_indices=None):
    ...
    :param random_state:
    :param labels: labels should be in one-hot encoding.
...
def get_dataset_and_split_planetoid(dataset, datapath):
