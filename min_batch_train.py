...
adj, features, labels = load_reddit()
...
dataset_train = SubGraph(adj, features, labels, idx_train)
dataset_val = SubGraph(adj, features, labels, idx_val)
dataset_test = SubGraph(adj, features, labels, idx_test)
...
for epoch in range(args.epochs):
    # TODO:
    train_loss, train_acc = loop_dataset(train_batch, optimizer, args.print_every, args.cuda)
